...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.council_vote_requested'
        db.add_column('remozilla_bug', 'council_vote_requested',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Bug.creator'
        db.alter_column('remozilla_bug', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Bug.assigned_to'
        db.alter_column('remozilla_bug', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Bug.council_vote_requested'
        db.delete_column('remozilla_bug', 'council_vote_requested')


        # Changing field 'Bug.creator'
        db.alter_column('remozilla_bug', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Bug.assigned_to'
        db.alter_column('remozilla_bug', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
