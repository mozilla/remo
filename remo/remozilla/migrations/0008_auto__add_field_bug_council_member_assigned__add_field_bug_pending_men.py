...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bug.council_member_assigned'
        db.add_column(u'remozilla_bug', 'council_member_assigned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Bug.pending_mentor_validation'
        db.add_column(u'remozilla_bug', 'pending_mentor_validation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding M2M table for field budget_needinfo on 'Bug'
        m2m_table_name = db.shorten_name(u'remozilla_bug_budget_needinfo')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('bug', models.ForeignKey(orm[u'remozilla.bug'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['bug_id', 'user_id'])


    def backwards(self, orm):
        # Deleting field 'Bug.council_member_assigned'
        db.delete_column(u'remozilla_bug', 'council_member_assigned')

        # Deleting field 'Bug.pending_mentor_validation'
        db.delete_column(u'remozilla_bug', 'pending_mentor_validation')

        # Removing M2M table for field budget_needinfo on 'Bug'
        db.delete_table(db.shorten_name(u'remozilla_bug_budget_needinfo'))
