...
urlpatterns = patterns(
    ...
    url(r'^mentor/(?P<mentor>\w+)/$', 'list_ng_reports', name='list_ng_reports_mentor'),
    url(r'^rep/(?P<rep>\w+)/$', 'list_ng_reports', name='list_ng_reports_rep'),
    url(r'^rep/(?P<rep>\w+)/%s/$' % FUNCTIONAL_AREA_REGEX,
        'list_ng_reports', name='list_ng_reports_rep_functional_area'),
    url(r'^mentor/(?P<mentor>\w+)/%s/$' % FUNCTIONAL_AREA_REGEX,
        'list_ng_reports', name='list_ng_reports_mentor_functional_area'),
