...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ReportEvent.link'
        db.alter_column('reports_reportevent', 'link', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'ReportLink.description'
        db.alter_column('reports_reportlink', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'ReportEvent.link'
        db.alter_column('reports_reportevent', 'link', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'ReportLink.description'
        db.alter_column('reports_reportlink', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
