...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NGReport.verified_recruitment'
        db.add_column('reports_ngreport', 'verified_recruitment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NGReport.verified_recruitment'
        db.delete_column('reports_ngreport', 'verified_recruitment')
