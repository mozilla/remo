...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NGReport.link_description'
        db.alter_column('reports_ngreport', 'link_description', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'NGReport.link_description'
        db.alter_column('reports_ngreport', 'link_description', self.gf('django.db.models.fields.CharField')(max_length=200))
