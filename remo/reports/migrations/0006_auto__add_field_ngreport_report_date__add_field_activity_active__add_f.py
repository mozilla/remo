...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NGReport.report_date'
        db.add_column('reports_ngreport', 'report_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 11, 28, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Activity.active'
        db.add_column('reports_activity', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Campaign.active'
        db.add_column('reports_campaign', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NGReport.report_date'
        db.delete_column('reports_ngreport', 'report_date')

        # Deleting field 'Activity.active'
        db.delete_column('reports_activity', 'active')

        # Deleting field 'Campaign.active'
        db.delete_column('reports_campaign', 'active')
    ...
    models = {
        ...
        'reports.ngreport': {
            ...
            'report_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)', 'blank': 'True'}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
