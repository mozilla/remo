...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['reports.Activity'].objects.create(name='Attended an Event')
        orm['reports.Activity'].objects.create(name='Created an Event')
        orm['reports.Activity'].objects.create(name='Participated in a campaign')

    def backwards(self, orm):
        "Write your backwards methods here."
        (orm['reports.Activity'].objects
                                .filter(name='Attended an Event').delete())
        (orm['reports.Activity'].objects
                                .filter(name='Created an Event').delete())
        (orm['reports.Activity'].objects
                                .filter(name='Participated in a campaign')
                                .delete())
