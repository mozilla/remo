...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NGReportComment'
        db.create_table('reports_ngreportcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('report', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.NGReport'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('reports', ['NGReportComment'])

        # Adding model 'Activity'
        db.create_table('reports_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('reports', ['Activity'])

        # Adding model 'Campaign'
        db.create_table('reports_campaign', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('reports', ['Campaign'])

        # Adding model 'NGReport'
        db.create_table('reports_ngreport', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ng_reports', to=orm['auth.User'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('mentor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ng_reports_mentored', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ng_reports', to=orm['reports.Activity'])),
            ('campaign', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ng_reports', null=True, to=orm['reports.Campaign'])),
            ...
            ('location', self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True)),
            ('is_passive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('link_description', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
            ('activity_description', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
        ))
        db.send_create_signal('reports', ['NGReport'])

        # Adding M2M table for field functional_areas on 'NGReport'
        db.create_table('reports_ngreport_functional_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ngreport', models.ForeignKey(orm['reports.ngreport'], null=False)),
            ('functionalarea', models.ForeignKey(orm['profiles.functionalarea'], null=False))
        ))
        db.create_unique('reports_ngreport_functional_areas', ['ngreport_id', 'functionalarea_id'])


    def backwards(self, orm):
        # Deleting model 'NGReportComment'
        db.delete_table('reports_ngreportcomment')

        # Deleting model 'Activity'
        db.delete_table('reports_activity')

        # Deleting model 'Campaign'
        db.delete_table('reports_campaign')

        # Deleting model 'NGReport'
        db.delete_table('reports_ngreport')

        # Removing M2M table for field functional_areas on 'NGReport'
        db.delete_table('reports_ngreport_functional_areas')
    ...
    models = {
        ...
        'reports.ngreport': {
            'Meta': {'ordering': "['-created_on']", 'object_name': 'NGReport'},
            ...
            'link_description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
