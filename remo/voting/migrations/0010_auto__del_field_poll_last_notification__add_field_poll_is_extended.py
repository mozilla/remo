...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'voting_poll', 'last_notification')

        # Adding field 'Poll.is_extended'
        db.add_column(u'voting_poll', 'is_extended',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'voting_poll', 'last_notification',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Poll.is_extended'
        db.delete_column(u'voting_poll', 'is_extended')
