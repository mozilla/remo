...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Poll.eligimate_groups'
        db.delete_column('voting_poll', 'eligimate_groups')

        # Adding field 'Poll.valid_groups'
        db.add_column('voting_poll', 'valid_groups',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.Group']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Poll.eligimate_groups'
        db.add_column('voting_poll', 'eligimate_groups',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Poll.valid_groups'
        db.delete_column('voting_poll', 'valid_groups_id')
    ...
    models = {
        ...
        'voting.poll': {
            ...
            'valid_groups': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.Group']"})
        },
        'voting.pollchoices': {
