...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poll.end'
        db.alter_column('voting_poll', 'end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Poll.start'
        db.alter_column('voting_poll', 'start', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Poll.end'
        db.alter_column('voting_poll', 'end', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Poll.start'
        db.alter_column('voting_poll', 'start', self.gf('django.db.models.fields.DateField')())
