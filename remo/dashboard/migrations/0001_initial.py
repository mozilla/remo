...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'dashboard_actionitem', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_items_assigned', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'dashboard', ['ActionItem'])


    def backwards(self, orm):
        # Deleting model 'ActionItem'
        db.delete_table(u'dashboard_actionitem')
