...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.mentor'
        db.add_column('profiles_userprofile', 'mentor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='mentors_users', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.mentor'
        db.delete_column('profiles_userprofile', 'mentor_id')
