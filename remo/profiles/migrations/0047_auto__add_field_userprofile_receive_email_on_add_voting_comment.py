...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.receive_email_on_add_voting_comment'
        db.add_column(u'profiles_userprofile', 'receive_email_on_add_voting_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.receive_email_on_add_voting_comment'
        db.delete_column(u'profiles_userprofile', 'receive_email_on_add_voting_comment')
    ...
    models = {
        ...
        u'profiles.useravatar': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
