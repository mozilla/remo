...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_streak_start'
        db.add_column('profiles_userprofile', 'current_streak_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.current_streak_end'
        db.add_column('profiles_userprofile', 'current_streak_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.longest_streak_start'
        db.add_column('profiles_userprofile', 'longest_streak_start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.longest_streak_end'
        db.add_column('profiles_userprofile', 'longest_streak_end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_streak_start'
        db.delete_column('profiles_userprofile', 'current_streak_start')

        # Deleting field 'UserProfile.current_streak_end'
        db.delete_column('profiles_userprofile', 'current_streak_end')

        # Deleting field 'UserProfile.longest_streak_start'
        db.delete_column('profiles_userprofile', 'longest_streak_start')

        # Deleting field 'UserProfile.longest_streak_end'
        db.delete_column('profiles_userprofile', 'longest_streak_end')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 31, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'profiles.userprofile': {
            ...
            'current_streak_end': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
