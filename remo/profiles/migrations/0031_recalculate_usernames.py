...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for user in (orm['auth.User'].objects
                     .filter(userprofile__registration_complete=True)):
            user.username = USERNAME_ALGO(user.email)
            user.save()
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 30, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
