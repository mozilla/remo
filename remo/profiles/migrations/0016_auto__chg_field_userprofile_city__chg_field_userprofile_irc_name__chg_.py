...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_userprofile', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.irc_name'
        db.alter_column('profiles_userprofile', 'irc_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.region'
        db.alter_column('profiles_userprofile', 'region', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.country'
        db.alter_column('profiles_userprofile', 'country', self.gf('django.db.models.fields.CharField')(max_length=50))
