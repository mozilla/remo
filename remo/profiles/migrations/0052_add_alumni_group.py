...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Create Alumni group."""
        orm['auth.Group'].objects.create(name='Alumni')

    def backwards(self, orm):
        """Delete Alumni Group."""
        orm['auth.Group'].objects.filter(name='Alumni').delete()
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
