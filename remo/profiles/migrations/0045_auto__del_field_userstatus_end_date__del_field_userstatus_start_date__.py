...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserStatus.end_date'
        db.delete_column(u'profiles_userstatus', 'end_date')

        # Deleting field 'UserStatus.start_date'
        db.delete_column(u'profiles_userstatus', 'start_date')

        # Adding field 'UserStatus.expected_date'
        db.add_column(u'profiles_userstatus', 'expected_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserStatus.return_date'
        db.add_column(u'profiles_userstatus', 'return_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserStatus.end_date'
        db.add_column(u'profiles_userstatus', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserStatus.start_date'
        db.add_column(u'profiles_userstatus', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserStatus.expected_date'
        db.delete_column(u'profiles_userstatus', 'expected_date')

        # Deleting field 'UserStatus.return_date'
        db.delete_column(u'profiles_userstatus', 'return_date')
    ...
    models = {
        ...
        u'profiles.useravatar': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 5, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
