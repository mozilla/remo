...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.irc_channels'
        db.add_column('profiles_userprofile', 'irc_channels', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.irc_channels'
        db.delete_column('profiles_userprofile', 'irc_channels')
