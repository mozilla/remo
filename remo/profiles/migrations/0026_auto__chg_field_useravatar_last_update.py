...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserAvatar.last_update'
        db.alter_column('profiles_useravatar', 'last_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserAvatar.last_update'
        db.alter_column('profiles_useravatar', 'last_update', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
