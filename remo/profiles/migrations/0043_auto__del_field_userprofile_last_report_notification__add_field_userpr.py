...
class Migration(SchemaMigration):
    depends_on = (
        ('reports', '0009_continuous_reporting'),
    )

    def forwards(self, orm):
        # Deleting field 'UserProfile.last_report_notification'
        db.delete_column(u'profiles_userprofile', 'last_report_notification')

        # Adding field 'UserProfile.first_report_notification'
        db.add_column(u'profiles_userprofile', 'first_report_notification',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.second_report_notification'
        db.add_column(u'profiles_userprofile', 'second_report_notification',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.last_report_notification'
        db.add_column(u'profiles_userprofile', 'last_report_notification',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.first_report_notification'
        db.delete_column(u'profiles_userprofile', 'first_report_notification')

        # Deleting field 'UserProfile.second_report_notification'
        db.delete_column(u'profiles_userprofile', 'second_report_notification')
    ...
    models = {
        ...
        u'profiles.useravatar': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
