...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.personal_website_url'
        db.alter_column('profiles_userprofile', 'personal_website_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'UserProfile.facebook_url'
        db.alter_column('profiles_userprofile', 'facebook_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'UserProfile.linkedin_url'
        db.alter_column('profiles_userprofile', 'linkedin_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'UserProfile.diaspora_url'
        db.alter_column('profiles_userprofile', 'diaspora_url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'UserProfile.personal_blog_feed'
        db.alter_column('profiles_userprofile', 'personal_blog_feed', self.gf('django.db.models.fields.URLField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.personal_website_url'
        db.alter_column('profiles_userprofile', 'personal_website_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.facebook_url'
        db.alter_column('profiles_userprofile', 'facebook_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.linkedin_url'
        db.alter_column('profiles_userprofile', 'linkedin_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.diaspora_url'
        db.alter_column('profiles_userprofile', 'diaspora_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'UserProfile.personal_blog_feed'
        db.alter_column('profiles_userprofile', 'personal_blog_feed', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
