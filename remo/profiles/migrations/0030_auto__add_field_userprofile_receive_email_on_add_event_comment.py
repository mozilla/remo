...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.receive_email_on_add_event_comment'
        db.add_column('profiles_userprofile', 'receive_email_on_add_event_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.receive_email_on_add_event_comment'
        db.delete_column('profiles_userprofile', 'receive_email_on_add_event_comment')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 11, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
