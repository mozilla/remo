...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_userprofile', 'display_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Changing field 'UserProfile.local_name'
        db.alter_column('profiles_userprofile', 'local_name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.display_name'
        db.alter_column('profiles_userprofile', 'display_name', self.gf('django.db.models.fields.CharField')(max_length=15, unique=True))

        # Changing field 'UserProfile.local_name'
        db.alter_column('profiles_userprofile', 'local_name', self.gf('django.db.models.fields.CharField')(max_length=50))
