...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.local_name'
        db.add_column('profiles_userprofile', 'local_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.local_name'
        db.delete_column('profiles_userprofile', 'local_name')
