...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userstatus', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 5, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStatus.start_date'
        db.delete_column('profiles_userstatus', 'start_date')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'profiles.userstatus': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 5, 13, 0, 0)', 'blank': 'True'}),
