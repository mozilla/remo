...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.gpg_key'
        db.delete_column('profiles_userprofile', 'gpg_key')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.gpg_key'
        db.add_column('profiles_userprofile', 'gpg_key', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)
