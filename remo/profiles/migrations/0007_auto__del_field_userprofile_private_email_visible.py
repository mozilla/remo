...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.private_email_visible'
        db.delete_column('profiles_userprofile', 'private_email_visible')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.private_email_visible'
        db.add_column('profiles_userprofile', 'private_email_visible', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
