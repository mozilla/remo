...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.registration_complete'
        db.add_column('profiles_userprofile', 'registration_complete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.registration_complete'
        db.delete_column('profiles_userprofile', 'registration_complete')
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'private_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
