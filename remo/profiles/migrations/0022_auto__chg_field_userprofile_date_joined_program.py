...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_userprofile', 'date_joined_program', self.gf('django.db.models.fields.DateField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.date_joined_program'
        db.alter_column('profiles_userprofile', 'date_joined_program', self.gf('django.db.models.fields.DateField')())
