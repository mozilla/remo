...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tracked_functional_areas on 'UserProfile'
        db.create_table('profiles_userprofile_tracked_functional_areas', (
        ...
        db.create_unique('profiles_userprofile_tracked_functional_areas', ['userprofile_id', 'functionalarea_id'])


    def backwards(self, orm):
        # Removing M2M table for field tracked_functional_areas on 'UserProfile'
        db.delete_table('profiles_userprofile_tracked_functional_areas')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 7, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
        ...
        'profiles.userprofile': {
            ...
            'functional_areas': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'functional_areas'", 'symmetrical': 'False', 'to': "orm['profiles.FunctionalArea']"}),
            ...
            'tracked_functional_areas': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'tracked_functional_areas'", 'symmetrical': 'False', 'to': "orm['profiles.FunctionalArea']"}),
