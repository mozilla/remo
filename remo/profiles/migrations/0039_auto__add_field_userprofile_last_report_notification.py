...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userprofile', 'last_report_notification',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profiles_userprofile', 'last_report_notification')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
