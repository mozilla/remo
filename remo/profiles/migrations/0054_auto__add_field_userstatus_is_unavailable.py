...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStatus.is_unavailable'
        db.add_column('profiles_userstatus', 'is_unavailable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStatus.is_unavailable'
        db.delete_column('profiles_userstatus', 'is_unavailable')
