...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Generate slugs for functional areas
        for functional_area in orm['profiles.FunctionalArea'].objects.all():
            functional_area.slug = slugify(functional_area.name)
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 3, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
