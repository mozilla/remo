...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.date_joined_program'
        db.add_column('profiles_userprofile', 'date_joined_program', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.date_joined_program'
        db.delete_column('profiles_userprofile', 'date_joined_program')
