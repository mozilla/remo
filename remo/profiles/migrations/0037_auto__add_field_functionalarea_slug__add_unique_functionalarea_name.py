...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FunctionalArea.slug'
        db.add_column('profiles_functionalarea', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'FunctionalArea', fields ['name']
        db.create_unique('profiles_functionalarea', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'FunctionalArea', fields ['name']
        db.delete_unique('profiles_functionalarea', ['name'])

        # Deleting field 'FunctionalArea.slug'
        db.delete_column('profiles_functionalarea', 'slug')
    ...
    models = {
        ...
        'profiles.useravatar': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_update': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 4, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
