...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EventGoal', fields ['name']
        db.create_index('events_eventgoal', ['name'])


    def backwards(self, orm):
        # Removing index on 'EventGoal', fields ['name']
        db.delete_index('events_eventgoal', ['name'])
