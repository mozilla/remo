...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.hashtag'
        db.alter_column('events_event', 'hashtag', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Event.hashtag'
        db.alter_column('events_event', 'hashtag', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
