...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.converted_visitors'
        db.add_column('events_event', 'converted_visitors',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.converted_visitors'
        db.delete_column('events_event', 'converted_visitors')
