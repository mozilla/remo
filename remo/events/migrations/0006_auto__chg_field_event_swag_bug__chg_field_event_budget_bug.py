...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.swag_bug'
        db.alter_column('events_event', 'swag_bug_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['remozilla.Bug']))

        # Changing field 'Event.budget_bug'
        db.alter_column('events_event', 'budget_bug_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['remozilla.Bug']))

    def backwards(self, orm):

        # Changing field 'Event.swag_bug'
        db.alter_column('events_event', 'swag_bug_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['remozilla.Bug']))

        # Changing field 'Event.budget_bug'
        db.alter_column('events_event', 'budget_bug_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['remozilla.Bug']))
