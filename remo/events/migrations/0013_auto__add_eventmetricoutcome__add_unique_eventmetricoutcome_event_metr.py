...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventMetricOutcome'
        db.create_table(u'events_eventmetricoutcome', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.Event'])),
            ('metric', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['events.EventMetric'])),
            ('outcome', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'events', ['EventMetricOutcome'])

        # Adding model 'EventMetric'
        db.create_table(u'events_eventmetric', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'events', ['EventMetric'])


    def backwards(self, orm):
        # Deleting model 'EventMetricOutcome'
        db.delete_table(u'events_eventmetricoutcome')

        # Deleting model 'EventMetric'
        db.delete_table(u'events_eventmetric')
